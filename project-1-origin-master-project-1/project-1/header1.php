        ...
        <?php else: ?>
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="modal" data-target="#logoutModal">
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $PAGE_USERNAME ?></span>
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle"
                                 src="Dash/startbootstrap-sb-admin-2-gh-pages/img/undraw_profile.svg">
                        </a>
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                         src="Dash/startbootstrap-sb-admin-2-gh-pages/img/undraw_posting_photo.svg" alt="...">
                                </div>
